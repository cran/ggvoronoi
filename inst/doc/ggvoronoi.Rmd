...
First we need to build a map of Oxford:
...
Here, we will be demonstrating the heatmap capabilites of ggvoronoi. California has one of the most varied geograhpies of any US state. So, we'll use ggvoronoi to create a heatmap of the altitude of California!
