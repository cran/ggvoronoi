...
First we need to download a map of Oxford:
...
Usng voronoi_polygon, we can build a Voronoi diagram as a SpatialPolygonsDataFrame.
...
Here, we will be demonstrating the heatmap capabilites of ggvoronoi. California has one of the most varied geographies of any US state. So, we'll use ggvoronoi to create a heatmap of the altitude of California!
